...
import { furnsh, str2et, spkez, spkezr } from '../src/index.js';
...
fs.writeFileSync(
  ...
  JSON.stringify({ str2etResults, spkezResults, spkezrResults }, null, 2)
);
console.log(
  `spiceJS: ${str2etResults.length} str2et cases, ${spkezResults.length} spkez cases, ` +
    `${spkezrResults.length} spkezr cases -> results-js.json`
);
